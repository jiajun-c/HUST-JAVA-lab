                    ...
                    if (indexSearcher == null) {
                        ...
                        if (opt2 == 1) {
                            ...
                            if (isIllegalWord(queryTerm1) || isIllegalWord(queryTerm2)) {
                                ...
                                resHits = indexSearcher.search(queryTerm1, queryTerm2, sorter, AbstractIndexSearcher.LogicalCombination.ADN);
                                showRes(resHits);
                            }
    ...
    public static void showRes(AbstractHit[] resHits) {
        if (resHits != null) {
            for (AbstractHit hit : resHits) {
                ...
                System.out.println("docContent: " + hit);
            }
            System.out.println("======================================================Split Line======================================================");
        } else {
